...
def get_parameter():
    ...
    parser.add_argument("--eta_1", default=0.05, type=float, help="step size of inner primal update for validation model")
    parser.add_argument("--eta_2", default=0.05, type=float, help="step size of inner dual update for validation model")
    parser.add_argument("--meta_eta_1", default=0.05, type=float,
                        help="step size for outer primal update")
    parser.add_argument("--meta_eta_2", default=0.05, type=float,
                        help="step size for outer dual update")
    # parser.add_argument("--pd_updates", default=1, type=int, help="inner primal-dual iteration")
    parser.add_argument("--eta_1_shift", default=5, type=float,
                        help="step size of inner primal update for validation model")
    parser.add_argument("--eta_2_shift", default=5, type=float,
                        help="step size of inner dual update for validation model")
    parser.add_argument("--meta_eta_1_shift", default=5, type=float,
                        help="step size for outer primal update")
    parser.add_argument("--meta_eta_2_shift", default=5, type=float,
                        help="step size for outer dual update")
    parser.add_argument("--num_iterations", default=25, type=int, help="outer iteration")
    ...
    parser.add_argument("--d_feature", default=11, type=int, help="feature size of the data set. for example, ny: 52 cls_syn_data:2; adult:16; communities_and_crime:100; bank:16; census_income:36")
    parser.add_argument("--data_path", default=r'C:\Users\fengm\Desktop\pdrftml\data\data', type=str, help="root to all dataset")
    parser.add_argument("--dataset", default=r'4city_selection', type=str, help="dataset folder name")
    parser.add_argument("--save", default=r'C:\Users\fengm\Desktop\pdrftml\4city_selection', type=str, help="save location")
    ...
    parser.add_argument("--shift_time", default=32, type=int, help="shift_time")
    parser.add_argument("--net_dim", default=7, type=int, help="net_dim")
    # parser.add_argument("--seed", default=231, type=int, help="random_seed")
...
if __name__ == "__main__":
    ...
    # seed = parser.seed
    shift_time = parser.shift_time
    eta_1_shift= parser.eta_1_shift
    eta_2_shift = parser.eta_2_shift
    meta_eta_1_shift= parser.meta_eta_1_shift
    meta_eta_2_shift = parser.meta_eta_2_shift
